...
The workflow is exactly the same as [creating Remove Background](/guides/code_sample/index.md#remove-background) except you use the `/mask` endpoint instead of `/cutout`.  
