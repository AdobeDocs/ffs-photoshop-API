...
For another example, see [Execute Individual Photoshop Action](code_sample/index.md#photoshop-actions-play-a-specific-action)
...
The actionJSON endpoint does support multiple inputs. If you would like to learn more about using multiple inputs with actionJSON, you can find this: [Multiple Inputs ActionJSON Example](code_sample/index.md#executing-an-actionjson-with-multiple-inputs).
