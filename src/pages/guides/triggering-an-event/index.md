...
To understand what webhook events are and how to set up your application to use them, start with [the page on using webhooks and events](../../getting-started/webhooks/index.md).
