...
When you generate a manifest for a document that contains artboards, the response includes an `artboards` array with structure and bounds. See the [Manifest Migration](../photoshop-v2/v1-to-v2/manifest-migration.md) guide for the manifest structure, or the [Generate Manifest Endpoint](../retrieve-manifest/index.md) for the request flow.
...
For full request/response details, examples, output formats, and migration from the v1 artboards endpoint, see the [Artboard Migration (V1 to V2)](../photoshop-v2/v1-to-v2/artboard-migration.md) guide.
