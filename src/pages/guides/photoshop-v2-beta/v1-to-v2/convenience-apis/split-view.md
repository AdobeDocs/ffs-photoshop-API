...
3. **Place Edited Image** - Places the edited image (`__ADDITIONAL_CONTENTS_PATH_0__`) on the right
...
14. **Place Logo** - Places the product logo (`__ADDITIONAL_CONTENTS_PATH_1__`)
...
- **`__ADDITIONAL_CONTENTS_PATH_0__`** → The edited/after image (right side of comparison)
- **`__ADDITIONAL_CONTENTS_PATH_1__`** → Your product logo (top-right overlay)

**Important:** The order of images in `additionalContents` array must match the placeholder indices!
