...
V1 also had a dedicated `/psdService/smartObject` endpoint for smart object place/replace workflows. This guide focuses on smart objects via `documentCreate`/`documentOperations` only.
